...
class FundSpiders():
    ...
    def getFundInfo(self,fund_code):
        ...
        :return:
        '''
        fund_url='http://fund.eastmoney.com/f10/jbgk_'+fund_code.replace("'", "") +'.html'
        res = getURL(fund_url)
    ...
    def getFundManagers(self,fund_code):
        ...
        :return:
        '''
        fund_url='http://fund.eastmoney.com/f10/jjjl_'+fund_code.replace("'", "") +'.html'
        res = getURL(fund_url)
        soup = BeautifulSoup(res.text, 'html.parser')
        result = {}
        manager={}
    ...
    def getFundNav(self,fund_code):
        ...
        try:
            ...
            '''
             fund_url='http://fund.eastmoney.com/f10/F10DataApi.aspx?type=lsjz&code='+fund_code.replace("'", "") +'&page=1&per=1'
             res = getURL(fund_url)
             #获取历史净值的总记录数
...
def main():
    ...
    mySQL._init_('192.168.1.21', 'adminis', 'adminis', 'invest')
